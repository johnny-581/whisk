...
export const VocabTracker = ({ words }: VocabTrackerProps) => {
  return (
    <div className="rounded-[24px] border border-white/60 bg-white/80 p-6 shadow-2xl backdrop-blur w-[300px]">
      ...
      <div className="mt-6 flex max-h-[60vh] flex-col gap-4 overflow-y-auto pr-2">
        {words.map(({ id, japanese_vocab, checked }) => {
          return (
            ...
            >
              {checked && <span className={`text-xl text-neutral-400`}>✓</span>}
